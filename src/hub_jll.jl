...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import hub_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("1414f103-7607-5802-8977-fcefe8d49cb7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "hub", artifacts_toml) for e in artifacts["hub"]]
...
if best_platform === nothing
    @debug("Unable to load hub; unsupported platform $(triplet(platform_key_abi()))")
else
